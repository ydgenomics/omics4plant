...
```shell
# 查看tif像素
python3 -c "from PIL import Image; Image.MAX_IMAGE_PIXELS = None; img = Image.open('/data/work/M.truncatula/tissue_seg/Y00710F6.raw.mRNA_tissue_cut.tif'); print(f'宽度(Width): {img.width}, 高度(Height): {img.height}')"
