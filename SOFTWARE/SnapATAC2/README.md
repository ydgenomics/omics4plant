...
- scATAC整合
  ...
  > - Nat Mach Intell | 南开陈盛泉团队提出scATAC-seq数据批次效应校正方法**Fountain** [github](https://github.com/BioX-NKU/Fountain) 
- 跨模态RNA和ATAC整合
  > - QB期刊 | 单细胞多组学“双剑”合璧，scRNA-seq + scATAC-seq整合方法大盘点 https://mp.weixin.qq.com/s/CpGLdBnI_c58Rz_qqoLSFg
  > - Nat Methods | scMultiBench: 单细胞多组学整合方法的多任务基准测试 https://mp.weixin.qq.com/s/VoEASFyG2CyLxBIyNFTkSw [tutorial](https://scglue.readthedocs.io/en/latest/)
