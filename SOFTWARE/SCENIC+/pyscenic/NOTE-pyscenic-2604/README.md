...
## DEMO [demo_os.sh](../Scripts/demo_os.sh)
> 对水稻数据构建转录调控网络
- **输入**
  ```shell
  $ tree /data/users/yangdong/yangdong_21113e8a547441b694ccb6966d58b409/online
  /data/users/yangdong/yangdong_21113e8a547441b694ccb6966d58b409/online
  ├── create_cistarget_motif_databases_yd.py
  ├── extract_promoter.R
  ├── from_planttfdb
  │   ├── Osj_TF_binding_motifs_information.txt
  │   └── Osj_TF_binding_motifs.meme
  ├── from_seurat
  │   └── EFH-0d_annotated.rds -> /data/input/Files/User/yangdong/WDL/scATAC-anno/EFH-0d_annotated.rds
  ├── process_motif.sh
  ├── rds2loom.R
  ├── ref
  │   ├── osa1_r7.all_models.gtf -> /data/users/yangdong/yangdong_aad9c0eec3ba48688ac1f8729ce11dba/online/scenic/input/osa1_r7.all_models.gtf
  │   └── osa1_r7.asm.chrs.fa -> /data/input/Files/User/yinzhanhao/index/rice/osa1_r7.asm.chrs.fa
  └── run_pyscenic.sh
...
- **还未跑pySCENIC**
  ```shell
  $ tree /data/users/yangdong/yangdong_21113e8a547441b694ccb6966d58b409/online -L 1
  /data/users/yangdong/yangdong_21113e8a547441b694ccb6966d58b409/online
  ├── create_cistarget_motif_databases_yd.py
  ├── extract_promoter.R
  ├── from_planttfdb
  ├── from_seurat
  ├── Os_3000bp_promoter.fasta
  ├── Os_motif_dir
  ├── Os_motifs_id.txt
  ├── Os.motifs_vs_regions.scores.feather
  ├── Os.regions_vs_motifs.rankings.feather
  ├── Os.regions_vs_motifs.scores.feather
  ├── Os_TF_binding_motifs_information.tbl
  ├── Os_tf.txt
  ├── process_motif.sh
  ├── rds2loom.R
  ├── ref
...
- for create_cistarget_motif_databases
  - fa
  - gtf
  - *from planttfdb* [note](https://github.com/ydgenomics/Scripts/blob/main/GRN/GRN-pySCENIC/create_cistarget_database/%E6%9E%84%E5%BB%BA%E6%8B%9F%E5%8D%97%E8%8A%A5pySCENIC%E7%9A%84cistarget%E6%96%87%E4%BB%B6.md)
...
### `4` [create_cistarget_motif_databases](../Scripts/create_cistarget_motif_databases_yd.py)
```shell
species=Os
...
### `5` [pySCENIC](../Scripts/run_pyscenic.sh)
```shell
...
sh run_pyscenic.sh $scenic_loom $tf_list $tbl_file $feather_file $n_cpus $rank_threshold $auc_threshold
```
